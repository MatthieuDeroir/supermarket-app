...
CREATE TABLE "CartLines" (
  "carteLineId" INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  "productId" varchar,
  "quantity" int,
  "cartId" int,
  "createdAt" timestamp
...
ALTER TABLE "CartLines" ADD FOREIGN KEY ("productId") REFERENCES "Products" ("productId");

ALTER TABLE "CartLines" ADD FOREIGN KEY ("cartId") REFERENCES "Carts" ("cartId");

ALTER TABLE "Products" ADD FOREIGN KEY ("taxCategoryId") REFERENCES "TaxCategory" ("taxCategoryId");

ALTER TABLE "Promotions" ADD FOREIGN KEY ("productId") REFERENCES "Products" ("productId");
